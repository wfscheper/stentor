...
func init() {
	...
	file4 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1602731628, 0),
	...
	file6 := &embedded.EmbeddedFile{
		Filename:    "markdown-header",
		FileModTime: time.Unix(1602731518, 0),
